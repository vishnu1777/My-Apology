    ...
    return (
        <section className="py-24 px-4 bg-rose-500 text-white text-center">
            <div className="max-w-3xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Will You Forgive Me?</h2>
                <p className="text-xl opacity-90 mb-8">I promise to be the person you deserve, today and every day.</p>
